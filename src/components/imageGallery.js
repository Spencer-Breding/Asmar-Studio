...
export default function ImageGallery() {
    ...
    const thumbList = [
        { source: "./images/thumbnails/CaterpillaThumb.webp", description: "Absolem Caterpillar Alice in Wonderland", priorityType: true, loadingType: "eager" },
        { source: "./images/thumbnails/AlaskaThumb.webp", description: "Alaska Air Tail Section Display", priorityType: true, loadingType: "eager" },
        { source: "./images/thumbnails/SiegeThumb.webp", description: "City Under Siege", priorityType: true, loadingType: "eager" },
