...
export default function ImageGallery() {
    ...
    const imageList = [
        ...
        { source: "./images/gallery/GiantLipstick.webp", description: "MAC Lipstick" },
        ...
        { source: "./images/gallery/KongHand.webp", description: "Kong's Hand" },
        ...
        { source: "./images/gallery/TRexHead2.webp", description: "Airbrushing" },
