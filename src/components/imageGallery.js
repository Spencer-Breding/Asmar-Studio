...
export default function ImageGallery() {
    ...
    const thumbList = [
        { source: "./images/thumbnails/CaterpillaThumb.webp", description: "Absolem Caterpillar Alice in Wonderland", priorityType: true },
        { source: "./images/thumbnails/AlaskaThumb.webp", description: "Alaska Air Tail Section Display", priorityType: true },
        { source: "./images/thumbnails/SiegeThumb.webp", description: "City Under Siege", priorityType: true },
